...
function SendMoney(){
   ...
   const idd=location.id;
    ...
    console.log(f,t);
        ...
        axios.post("http://localhost:5000/transactions/",re).then((res)=>{// axios sends the http async req to end points , here we are sending to port o 4000.
        console.log("success");
      ...
      //  history.push("/Main/Transactions/");
        ...
        const g= async()=>{
                    ...
                    axios.delete("http://localhost:5000/req/"+idd).then((res)=>{
                    }).catch((err)=>{
...
//                      response.status(400).json("req does not exist");
    ...
    const gu=async()=>{
        ...
        var f={};
            ...
            const tt="http://localhost:5000/users/"+all.acc;
            axios.patch(tt,all).then((res)=>{
                console.log(res);
            }).catch((err)=>{
                console.log(err);
            })
           ...
           axios.get(p).then((res)=>{
            ...
            const t="http://localhost:5000/users/"+all.acc;

            axios.patch(t,all).then((res)=>{
                console.log(res);
            }).catch((err)=>{
                console.log(err);
            })
